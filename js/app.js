    ...
    (() => {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        const curentSlide = document.querySelector(".fraction-controll__curent");
                        curentSlide.innerHTML = swiper.activeIndex + 1 < 10 ? `0${swiper.activeIndex + 1}` : swiper.activeIndex + 1;
                    }
                }
            });
            if (document.querySelector(".products-slider__slider")) new core(".products-slider__swiper", {
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                const subMenu = document.querySelector(`[data-child = "${subMenuId}"]`);
                document.querySelector(".catalog__header");
                if (subMenu) {
            ...
            if (targetElement.closest(".menu-catalog__back")) {
                ...
                documentElement.querySelectorAll("._sub-menu-active") ? documentElement.querySelectorAll("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                documentElement.querySelectorAll("._sub-menu-open") ? documentElement.querySelectorAll("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                e.preventDefault();
            }
